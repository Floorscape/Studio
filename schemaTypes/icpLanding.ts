...
export const icpLanding = defineType({
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          {title: 'Core homeowner', value: 'core-homeowner'},
          {title: 'Premium lifestyle', value: 'premium-lifestyle'},
          {title: 'New build (south-east)', value: 'new-build'},
          {title: 'Fitout builder', value: 'fitout-builder'},
          {title: 'Architect / specifier', value: 'architect'},
          {title: 'DIY rescue', value: 'diy-rescue'},
          {title: 'Recoat specialist', value: 'recoat-specialist'},
          {title: 'Forensic report', value: 'forensic-report'},
